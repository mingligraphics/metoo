...
function ready(datapoints) {
  ...
  d3.select('#block5').append('image').attr('x', 3).attr('y', 3).attr('width', 50).attr('height', 50).attr('xlink:href', require('../images/P-images/5.png')).attr('class', 'image5');
  ...
  d3.select('#block52').append('image').attr('x', 3).attr('y', 3).attr('width', 52).attr('height', 52).attr('xlink:href', require('../images/P-images/52.png')).attr('class', 'image52');
